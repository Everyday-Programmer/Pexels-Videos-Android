...
public class PexelsApiClient {
    private static final String API_KEY = "563492ad6f91700001000001f8018fa3798844489979ded127c25470";
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        for (int i = 0; i < videosArray.length(); i++) {
                            ...
                            video.setFile_type(videoObject.getJSONArray("video_files").getJSONObject(0).getString("file_type"));
